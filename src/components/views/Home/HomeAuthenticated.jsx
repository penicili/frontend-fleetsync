        ...
        <div className="max-w-3xl w-full bg-white rounded-xl shadow-lg p-8">
          ...
          <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <button
              ...
              className="bg-blue-50 p-4 rounded-lg border border-blue-200 hover:shadow-md hover:bg-blue-100 transition-colors text-left w-full"
            >
              <h3 className="font-bold text-blue-800">Route Management</h3>
              <p className="text-blue-600 text-sm">Manage travel routes and statuses</p>
            </button>
          </div>
          ...
          {session.accessToken && (
            <div className="mt-8 p-4 bg-gray-50 rounded-lg">
              ...
              >
                ...
                <button
                  className="text-blue-600 hover:text-blue-800 text-sm flex items-center transition-all duration-300 ease-in-out"
                >
